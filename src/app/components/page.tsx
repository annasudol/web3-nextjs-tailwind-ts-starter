          ...
          <ol className='mt-8 space-y-6'>
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <ButtonLink href='https://github.com/theodorusclarence/ts-nextjs-tailwind-thirweb-starter
/blob/main/src/styles/colors.css'>
            ...
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnstyledLink href='https://github.com/annasudol'>
                  Outside Links
                </UnstyledLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <PrimaryLink href='https://github.com/annasudol'>
                  Outside Links
                </PrimaryLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnderlineLink href='https://github.com/annasudol'>
                  Outside Links
                </UnderlineLink>
              </div>
            </li>
            ...
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <ButtonLink variant='dark' href='https://github.com/annasudol'>
                  Dark Variant
                </ButtonLink>
                <ButtonLink
                  variant='light'
